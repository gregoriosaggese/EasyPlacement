...
<body>
	...
	<div>
		<form action="InviaQuestionario" onsubmit="return(validator2())"
			...
			<div>
				<strong><label>La durata del tirocinio è stata
			...
			<div>
				<strong><label>La collaborazione con il Tutor
						Didattico è stata &emsp;&emsp; </label></strong> 1/insufficiente<input type="radio"
			...
			<div>
				<strong> <label>Il tirocinio formativo è utile
